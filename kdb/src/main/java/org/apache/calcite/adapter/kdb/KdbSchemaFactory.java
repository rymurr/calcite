...
/**
 * Factory that creates a {@link KdbSchema}.
 *
 * <p>Allows a custom schema to be included in a model.json file.</p>
 */
@SuppressWarnings("UnusedDeclaration")
public class KdbSchemaFactory implements SchemaFactory {
  // public constructor, per factory contract
  public KdbSchemaFactory() {
  }
  ...
  public Schema create(SchemaPlus parentSchema, String name,
    ...
    return new KdbSchema(hostname, port, null, null);
  }
}

// End KdbSchemaFactory.java
