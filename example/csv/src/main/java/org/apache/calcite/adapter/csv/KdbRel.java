 ...
 */
public interface KdbRel extends RelNode {
  void implement(Implementor implementor);

  /** Calling convention for relational operations that occur in MongoDB. */
  Convention CONVENTION = new Convention.Impl("KDB", KdbRel.class);

  /** Callback for the implementation process that converts a tree of
   * {@link KdbRel} nodes into a MongoDB query. */
  class Implementor {
